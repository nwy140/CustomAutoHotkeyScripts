...
; In case you have another browser, replace where it says "vivaldi" 
...
^+1::YoutubeRewind("ahk_exe vivaldi.exe")
^+2::YoutubeForwind("ahk_exe vivaldi.exe")
^+3::Media_Play_Pause

Media_Next::YoutubeForwind("ahk_exe vivaldi.exe")

Media_Prev::YoutubeRewind("ahk_exe vivaldi.exe")
